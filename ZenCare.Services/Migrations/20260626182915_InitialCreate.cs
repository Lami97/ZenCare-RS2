    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WellnessServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WellnessServices_ServiceCategories_ServiceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessReports_Users_GeneratedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WellnessServiceId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendationLogs_Products_ProductId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecommendationLogs_WellnessServices_WellnessServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_WellnessServices_WellnessServiceId",
                        column: x => x.WellnessServiceId,
                        principalTable: "WellnessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeServices_WellnessServices_WellnessServiceId",
                        column: x => x.WellnessServiceId,
                        principalTable: "WellnessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    StripePaymentIntentId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    StripeChargeId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    PaidAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_WellnessServiceId",
                table: "Appointments",
                column: "WellnessServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessReports_GeneratedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeServices_EmployeeId_WellnessServiceId",
                table: "EmployeeServices",
                columns: new[] { "EmployeeId", "WellnessServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeServices_WellnessServiceId",
                table: "EmployeeServices",
                column: "WellnessServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecommendationLogs_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecommendationLogs_WellnessServiceId",
                table: "RecommendationLogs",
                column: "WellnessServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WellnessServices_ServiceCategoryId",
