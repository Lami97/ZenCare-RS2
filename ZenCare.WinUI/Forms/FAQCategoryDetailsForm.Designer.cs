...
partial class FAQCategoryDetailsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        txtDescription.Size = new Size(416, 80);
        txtDescription.TabIndex = 3;
        // 
        // chkIsActive
        // 
        chkIsActive.AutoSize = true;
        chkIsActive.Location = new Point(24, 204);
        ...
        // btnCancel
        // 
        btnCancel.Location = new Point(356, 248);
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "FAQCategoryDetailsForm";
        StartPosition = FormStartPosition.CenterParent;
        Text = "FAQ Category";
        Load += FAQCategoryDetailsForm_Load;
        ResumeLayout(false);
        PerformLayout();
    }
